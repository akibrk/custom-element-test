(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ce-test"] = factory(require("vue"));
	else
		root["ce-test"] = factory(root["Vue"]);
...
/* harmony default export */ var custom_element_cevue_type_script_lang_ts = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  name: 'ce-test',
  props: {
    dataName: {
      type: String,
  ...
  mounted: function mounted() {
    console.log(_typeof(this.dataName));
  }
}));
...
var CustomComponent = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineCustomElement"])(custom_element_ce); // Registers the custom element if its' not yet registered

try {
  var isDefined = customElements.get(custom_element_ce.name);

  if (!isDefined) {
    console.log('defining custom-element');
    customElements.define(custom_element_ce.name, CustomComponent);
  }
} catch (error) {
  console.error(error);
}
...
//# sourceMappingURL=ce-test.umd.js.map